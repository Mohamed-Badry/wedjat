<script lang="ts">
  ...
  const MODELS = [
    { name: 'Autoencoder', auroc: 0.844, color: '#2ec4b6',
      pts: [{fpr:0,tpr:0},{fpr:.005,tpr:.38},{fpr:.02,tpr:.46},{fpr:.05,tpr:.53},{fpr:.1,tpr:.59},{fpr:.15,tpr:.65},{fpr:.2,tpr:.71},{fpr:.4,tpr:.83},{fpr:.7,tpr:.93},{fpr:1,tpr:1}] },
    { name: 'Elliptic Env', auroc: 0.869, color: '#94a3b8',
      pts: [{fpr:0,tpr:0},{fpr:.005,tpr:.57},{fpr:.02,tpr:.60},{fpr:.05,tpr:.63},{fpr:.1,tpr:.67},{fpr:.15,tpr:.73},{fpr:.2,tpr:.79},{fpr:.4,tpr:.89},{fpr:.7,tpr:.96},{fpr:1,tpr:1}] },
